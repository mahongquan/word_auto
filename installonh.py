...
def last():
    ...
    try:
        ...
        a=input("error ")
def main():
    #if os.path.exists(r"c:\Program Files\NCS") and os.path.exists(r"C:\ADLINK\PCIS-DASK"):
    if (os.path.exists(destdrive+r"\Program Files\NCS") or os.path.exists(destdrive+r"\Program Files (x86)\NCS") )and os.path.exists(r"C:\ADLINK\PCIS-DASK"):
